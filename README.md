...
This directory contains small, self-contained examples demonstrating how to use Cronos402 components and services.
...
- `minimal-mcp-client/` – Small client example that calls MCP via `cronos402` SDK
